...
# Description of the Game:
  ...
  ### Game Rules:
     The user-interfece would provide the player with a super-remove bottom, 2 location coordinates input windows and a picture with random figures distribution.  
     ...
     super-remove buttom: randomly eliminate one connectable pair regardless the limitation of the above rules.
